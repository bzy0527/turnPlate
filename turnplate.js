...
DBFX.Web.Controls.TurnPlate = function (t) {
    ...
    tp.startBtnClick = function (ev) {
        ...
        //计算需要旋转到的奖品位置（角度）
        tp.index = !tp.selectedIndex ? tp.getRandom(0,tp.itemSource.length-1) : tp.selectedIndex;
    ...
    tp.drawWheel = function () {
        ...
        for(var i = 0; i < tp.itemSource.length; i++) {
            ...
            //绘制对应图标
            var img = new Image();
            img.src = tp.itemSource[i].imgSrc;
            img.onload = function () {
        ...
        // ctx.lineWidth = 0;
        // ctx.moveTo(tp.canvas.width*0.5,tp.canvas.height*0.5);
        // ctx.lineTo(tp.canvas.width*0.5,tp.canvas.height*0.5-tp.textRadius*0.7);
        // ctx.lineTo(tp.canvas.width*0.5-tp.insideRadius*0.4,tp.canvas.height*0.5);
        // ctx.closePath();
        // ctx.stroke();
        // ctx.fill();
        //
        ...
        //
        // ctx.fillStyle = "#E62D2D";
        // ctx.arc(tp.canvas.width*0.5,tp.canvas.height*0.5,
        //         tp.insideRadius*0.92,0,Math.PI*2);
        // ctx.fill();
        // ctx.beginPath();
        // ctx.fillStyle = "#CA1518";
        // ctx.arc(tp.canvas.width*0.5,tp.canvas.height*0.5,
        //         tp.insideRadius*0.75,0,Math.PI*2);
        // // var pointerImg = new Image();
        // // pointerImg.src = tp.pointerImgSrc;
        // // ctx.drawImage(pointerImg,tp.canvas.width*0.5-pointerImg.width*0.5,tp.canvas.height*0.5 - pointerImg.height*0.62);
        // ctx.fill();
        //
        // ctx.beginPath();
        // ctx.font = 'bold 30px Microsoft YaHei';
        // ctx.font = ctx.font.replace(/\d+(\.\d+)?(px|pt|em|%)/i, tp.insideRadius * 0.5 + "px");//替换字体大小
        // ctx.textAlign = "center";
        // ctx.textBaseline = "middle";
        // ctx.fillStyle = "#FFBE04";
        // ctx.fillText("抽奖",tp.canvas.width*0.5,tp.canvas.height*0.5);
        // ctx.restore();
    }
